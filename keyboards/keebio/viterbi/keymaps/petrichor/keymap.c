...
enum layers { _DVORAK, _QWERTY, _FN1, _FN2, _FN3, _MOUSE };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT_ortho_5x14(
    ...
    XXXXXXX, KC_TAB , KC_QUOT, KC_COMM, KC_DOT , KC_P   , KC_Y   ,     KC_F   , KC_G   , KC_C   , KC_R   , KC_L   , KC_SLSH, KC_EQL,
    XXXXXXX, KC_LCTL, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   ,     KC_D   , KC_H   , KC_T   , KC_N   , KC_S   , KC_MINS, KC_ENT ,
    KC_PGUP, KC_LSPO, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   ,     KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_RSPC, KC_BSLS,
    KC_PGDN, KC_ESC , T_MOUSE, KC_LGUI, KC_LALT, KC_FN3 , BS_FN1 ,     SP_FN2 , KC_RALT, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_RCTL
  ),
  ...
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    KC_PGDN, KC_ESC , KC_LCTL, KC_LALT, KC_LGUI, KC_FN3 , BS_FN1 ,     SP_FN2 , KC_FN2 , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_BSLS
  ),

  [_FN1] = LAYOUT_ortho_5x14(
	KC_INS , KC_TILD, KC_F1  , KC_F2  , KC_F3  , ALT_F4 , KC_F5  ,     _______, _______, KC_PSLS, KC_PAST, KC_PMNS, _______, _______,
    KC_UNDS, _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,     _______, KC_P7  , KC_P8  , KC_P9  , KC_PPLS, KC_LCBR, KC_RCBR,
    KC_PLUS, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     _______, KC_P4  , KC_P5  , KC_P6  , KC_PPLS, KC_LBRC, KC_RBRC,
  ...
  [_FN3] = LAYOUT_ortho_5x14(
    ...
    UC_M_WI, DF_QWER, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
    UC_M_WC, DF_DVOR, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
