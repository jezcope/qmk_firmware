...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT_ortho_5x14(
    ...
    KC_PGUP, KC_LSPO, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   ,     KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_RSPC, ALT_TAB,
    KC_PGDN, KC_ESC , KC_FN3 , KC_LGUI, KC_LALT, BS_FN1 , BS_FN1 ,     SP_FN2 , KC_FN3 , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_RCTL
  ),

  [_FN1] = LAYOUT_ortho_5x14(
    M_BEST , KC_TILD, KC_F1  , KC_F2  , KC_F3  , ALT_F4 , KC_F5  ,     _______, KC_P7  , KC_P8  , KC_P9  , _______, _______, _______,
    ...
    KC_HOME, _______, KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,     _______, KC_P0  , KC_P0  , KC_PDOT, _______, KC_LPRN, KC_RPRN,
    KC_END , _______, _______, _______, _______, _______, _______,     _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_MUTE
  ),
  ...
  [_FN2] = LAYOUT_ortho_5x14(
    ...
    M_THNKS, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_MINS, KC_EQL , KC_LBRC, KC_RBRC, _______, _______,
    M_CHRS , _______, KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,     KC_F12 , KC_NUHS, KC_NUBS, _______, _______, _______, _______,
  ...
  [_FN3] = LAYOUT_ortho_5x14(
    ...
    UC_M_WN, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
    UC_M_WC, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
